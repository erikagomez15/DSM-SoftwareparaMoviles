package sv.edu.udb.guia7_complementario;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Button goBtn,fbtn;
    private FirebaseAuth mAuth;
    private static final int Google_sing_in = 200;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar.setVisibility((View.VISIBLE));
            ...
            if (TextUtils.isEmpty(email)) {
                Toast.makeText(getApplicationContext(), "Por favor ingrese su email", Toast.LENGTH_LONG).show();
                return;
            }
